...
- (instancetype)initWithPaymentDetails:(id<VTPaymentDetails>)paymentDetails transactionDetails:(VTTransactionDetails *)transactionDetails customerDetails:(VTCustomerDetails *)customerDetails itemDetails:(NSArray<VTItem *> *)itemDetails {
    if (self = [super init]) {
        self.paymentDetails = paymentDetails;
        self.transactionDetails = transactionDetails;
...
- (NSDictionary *)dictionaryValue {
    ...
    if (self.customerDetails) {
        [result setValue:[self.customerDetails dictionaryValue] forKey:@"item_details"];
    }
    if (self.itemDetails) {
